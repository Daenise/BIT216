...
<body>
  ...
  <div id="navigation">
    ...
    <div>
      <form name="postJobForm" action="../php/updateJob.php" method="post">
        <div class="row" style="margin-top: 50px;">
          <div class="col-sm-offset-2 col-sm-8">

            <div class="form-group">
              <label>Job Title: </label>
              <input type="text" name="jobTitle" placeholder="<?php echo $row['title'] ?> "
              class="form-control" required>
            </div>

            <div class="form-group">
              <label>Job Scope: </label>
              <input type="text" name="jobScope" placeholder="<?php echo $row['scope'] ?>"
              class="form-control"
              required>
            </div>
            ...
            <div class="form-group col-md-6">
              ...
              <select name="jLocation" class="form-control" required>
            ...
            <div class="form-group col-md-6">
              ...
              <select name="jSkill" class="form-control" required>
        ...
        <input type=hidden name=hidden2 value ="<?php echo $row['jobID'] ?>" >
